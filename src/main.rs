...
fn main() -> Result<()> {
    ...
    let func = match cli.day {
        1 => if cli.part == 1 { day01::part1 } else { day01::part2 },
        // 2 => if cli.part == 1 { day02::part1 } else { day02::part2 },
        // 3 => if cli.part == 1 { day03::part1 } else { day03::part2 },
        // 4 => if cli.part == 1 { day04::part1 } else { day04::part2 },
        // 5 => if cli.part == 1 { day05::part1 } else { day05::part2 },
        // 6 => if cli.part == 1 { day06::part1 } else { day06::part2 },
        // 7 => if cli.part == 1 { day07::part1 } else { day07::part2 },
        // 8 => if cli.part == 1 { day08::part1 } else { day08::part2 },
        // 9 => if cli.part == 1 { day09::part1 } else { day09::part2 },
